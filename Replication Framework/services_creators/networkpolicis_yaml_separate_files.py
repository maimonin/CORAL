...
def create_networkpolicy_seperate_files(child_address, parents_ms_list):
    """
    Creates new YAML files of NetworkPolicies for neww child microservices to be added to the cluster.
    Creates number of NetworkPolicy YAMLs as number of parents microservices
    (all the traffic in the application is incoming - ingress).
