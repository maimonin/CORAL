...
def create_recommendationservice_yamls(idx, used_ports, child_to_parents_relations, child_addresses_product):
    ...
    with open(
            get_path(r'utils\recommendationservice-yamls\recommendationservice-deploy.yaml'),
            'r') as f_in:
        with open(
    ...
    with open(
             get_path(r'utils\recommendationservice-yamls\recommendationservice-svc.yaml'),
            'r') as f_in:
        with open(
