...
def create_checkoutservice_yamls(idx, used_ports, child_to_parents_relations,
    ...
    with open(get_path(r'utils\checkout-yamls\checkoutservice-deploy.yaml'),
              'r') as f_in:
        with open(
                f'yamls-to-apply/checkoutservice-apply/checkoutservice-deploy-{idx}.yaml',
                'w') as f_out:
    ...
    with open(get_path(r'utils\checkout-yamls\checkoutservice-svc.yaml'),
              'r') as f_in:
        with open(
                f'yamls-to-apply/checkoutservice-apply/checkoutservice-svc-{idx}.yaml',
                'w') as f_out:
